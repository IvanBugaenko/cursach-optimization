...
const handleChangePop = (event, newValue) => {
 ...
 return (
    ...
    <div>
        <div>
    <TextField size = "small" defaultValue = {dictionary["population_dim"]} id="standard-basic" label="Размер популяци"variant="standard" onChange={handleChangePop} />
    <TextField size = "small" defaultValue = {dictionary["tournament_size"]} id="standard-basic" label="Размер Турнира"variant="standard" onChange={ handleChangeSize} />
    <br></br>
    <TextField size = "small" defaultValue = {dictionary["steps"]}  id="standard-basic" label="Число шагов"variant="standard"  onChange={handleChangeStep}/>
    <TextField size = "small" defaultValue = {dictionary["exchange_num"]}  id="standard-basic" label="Количество мутаций "variant="standard" onChange={handleChangeValueMut} />
    </div>
